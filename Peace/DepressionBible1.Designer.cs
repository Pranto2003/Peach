namespace Peace
{
    partial class DepressionBible1
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            More.Location = new Point(76, 340);
            More.Name = "More";
            More.Size = new Size(146, 63);
            More.TabIndex = 0;
            More.Text = "More";
            ...
            Return.BackgroundImageLayout = ImageLayout.Zoom;
            Return.Font = new Font("Segoe UI", 10.8F, FontStyle.Bold, GraphicsUnit.Point, 0);
            Return.Location = new Point(321, 340);
            Return.Name = "Return";
            Return.Size = new Size(146, 63);
            Return.TabIndex = 1;
            Return.Text = "Return";
            ...
            Exit.Location = new Point(566, 340);
            Exit.Name = "Exit";
            Exit.Size = new Size(146, 63);
            Exit.TabIndex = 2;
            Exit.Text = "Exit";
            ...
            BackgroundImage = Properties.Resources.DepressionBible1;
            ...
            Controls.Add(More);
            DoubleBuffered = true;
            Name = "DepressionBible1";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "DepressionBible1";
            ResumeLayout(false);
        }
