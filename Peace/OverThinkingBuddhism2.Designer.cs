namespace Peace
{
    partial class OverThinkingBuddhism2
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            More.Location = new Point(54, 344);
            More.Name = "More";
            More.Size = new Size(153, 64);
            More.TabIndex = 0;
            More.Text = "More";
            ...
            Return.Location = new Point(320, 344);
            Return.Name = "Return";
            Return.Size = new Size(153, 64);
            Return.TabIndex = 1;
            Return.Text = "Return";
            ...
            Exit.Location = new Point(584, 344);
            Exit.Name = "Exit";
            Exit.Size = new Size(153, 64);
            Exit.TabIndex = 2;
            Exit.Text = "Exit";
            Exit.UseVisualStyleBackColor = false;
            Exit.Click += Exit_Click;
            // 
            // OverThinkingBuddhism2
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            BackColor = Color.FromArgb(60, 60, 80);
            BackgroundImage = Properties.Resources.OverthinkingBuddhism2;
            ...
            Controls.Add(More);
            DoubleBuffered = true;
            Name = "OverThinkingBuddhism2";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "OverThinkingBuddhism2";
            ResumeLayout(false);
        }
