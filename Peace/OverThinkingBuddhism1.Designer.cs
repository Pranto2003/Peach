namespace Peace
{
    partial class OverThinkingBuddhism1
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            More.Location = new Point(57, 339);
            More.Name = "More";
            More.Size = new Size(143, 64);
            More.TabIndex = 0;
            More.Text = "More";
            ...
            Return.Location = new Point(327, 339);
            Return.Name = "Return";
            Return.Size = new Size(143, 64);
            Return.TabIndex = 1;
            Return.Text = "Return";
            ...
            Exit.Location = new Point(592, 339);
            Exit.Name = "Exit";
            Exit.Size = new Size(143, 64);
            Exit.TabIndex = 2;
            Exit.Text = "Exit";
            Exit.UseVisualStyleBackColor = false;
            Exit.Click += Exit_Click;
            // 
            // OverThinkingBuddhism1
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            BackColor = Color.FromArgb(60, 60, 80);
            BackgroundImage = Properties.Resources.OverthinkingBuddhism1;
            ...
            Controls.Add(More);
            DoubleBuffered = true;
            Name = "OverThinkingBuddhism1";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "OverThinkingBuddhism1";
            ResumeLayout(false);
        }
