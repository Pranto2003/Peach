namespace Peace
{
    partial class InconsistancyBuddhism2
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            More.Location = new Point(57, 336);
            More.Name = "More";
            More.Size = new Size(125, 63);
            More.TabIndex = 0;
            More.Text = "More";
            ...
            Return.Location = new Point(337, 336);
            Return.Name = "Return";
            Return.Size = new Size(125, 63);
            Return.TabIndex = 1;
            Return.Text = "Return";
            ...
            Exit.Location = new Point(611, 336);
            Exit.Name = "Exit";
            Exit.Size = new Size(125, 63);
            Exit.TabIndex = 2;
            Exit.Text = "Exit";
            Exit.UseVisualStyleBackColor = false;
            Exit.Click += Exit_Click;
            // 
            // InconsistancyBuddhism2
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            BackColor = Color.FromArgb(60, 60, 80);
            BackgroundImage = Properties.Resources.ConsistancyBuddhism2;
            ...
            Controls.Add(More);
            DoubleBuffered = true;
            Name = "InconsistancyBuddhism2";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "InconsistancyBuddhism2";
            ResumeLayout(false);
        }
