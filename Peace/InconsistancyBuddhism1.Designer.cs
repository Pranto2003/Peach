namespace Peace
{
    partial class InconsistancyBuddhism1
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            More.Location = new Point(56, 322);
            More.Name = "More";
            More.Size = new Size(126, 75);
            More.TabIndex = 0;
            More.Text = "More";
            ...
            Return.Location = new Point(335, 322);
            Return.Name = "Return";
            Return.Size = new Size(126, 75);
            Return.TabIndex = 1;
            Return.Text = "Return";
            ...
            Exit.Location = new Point(601, 322);
            Exit.Name = "Exit";
            Exit.Size = new Size(126, 75);
            Exit.TabIndex = 2;
            Exit.Text = "Exit";
            Exit.UseVisualStyleBackColor = false;
            Exit.Click += Exit_Click;
            // 
            // InconsistancyBuddhism1
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            BackColor = Color.FromArgb(60, 60, 80);
            BackgroundImage = Properties.Resources.ConsistancyBuddhism1;
            ...
            Controls.Add(More);
            DoubleBuffered = true;
            Name = "InconsistancyBuddhism1";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "InconsistancyBuddhism1";
            ResumeLayout(false);
        }
